...
export class RegisterComponent implements OnInit {
  ...
  constructor(private encript: EncriptService, private userService: UserService, private authenticationService: AuthenticationService, private recaptchaV3Service: ReCaptchaV3Service) { }
  ...
  registerUser() {
    this.recaptchaV3Service.execute('action').subscribe(
      (token) => {
        ...
        if (this.client.document_number == '' || this.client.pk_fk_id_document_type == 0 || this.client.fk_id_gender == 0 || this.client.first_name == '' || this.client.surname == '' || this.client.email == '' || this.client.password_user == '') {
          ...
          this.client.password_user = this.encript.set('123456$#@$^@1ERF', this.client.password_user);
