...
export class TicketService {
  ...
  getBlocksClose(token: any) {
    let headers = new HttpHeaders({ 'x-token': token });
    return this.http.get(`${this.API_URI}/global/blockClose`, { 'headers': headers });
  }

  getVehicles(token: any) {
    let headers = new HttpHeaders({ 'x-token': token });
    return this.http.get(`${this.API_URI}/global/vehicle`, { 'headers': headers });
  }

  getOnePDF(token: any, id: string) {
    let headers = new HttpHeaders({ 'x-token': token });
    return this.http.get(`${this.API_URI}/tickets/getOnePDF/${id}`, { 'headers': headers })
  }
  ...
  getTicket(token: any, id: string) {
    let headers = new HttpHeaders({ 'x-token': token });
    return this.http.get(`${this.API_URI}/tickets/getOne/${id}`, { 'headers': headers });
  }
  ...
  deleteTicket(token: any, id: string) {
    let headers = new HttpHeaders({ 'x-token': token });
    return this.http.delete(`${this.API_URI}/tickets/delete/${id}`, { 'headers': headers });
  }
}
