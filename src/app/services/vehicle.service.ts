...
export class VehicleService {
  ...
  getVehicleType(token: any) {
    let headers = new HttpHeaders({ 'x-token': token });
    return this.http.get(`${this.API_URI}/global/vehicleType`, {
      headers: headers,
    });
  }
  ...
  getVehicle(token: any, id: String) {
    let headers = new HttpHeaders({ 'x-token': token });
    return this.http.get(`${this.API_URI}/vehicles/getOne/${id}`, {
      headers: headers,
    });
  }
  ...
  deleteVehicle(token: any, id: String) {
    let headers = new HttpHeaders({ 'x-token': token });
    return this.http.delete(`${this.API_URI}/vehicles/delete/${id}`, {
      headers: headers,
    });
  }
}
